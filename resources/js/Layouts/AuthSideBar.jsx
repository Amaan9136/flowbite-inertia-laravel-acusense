...
const AuthSideBar = () => {
  return (
    <nav className="flex-col w-56 bg-gray-50 text-black/60 dark:bg-gray-900 dark:text-white/60 space-y-1 shadow-md p-2 hidden sm:block h-full border-r-2 border-[#343E4E]">
