  ...
  return (
    <nav className="relative hidden sm:block min-w-[15rem] w-[15rem] space-y-2 bg-gray-50 text-black/60 dark:bg-gray-900 dark:text-white/60 shadow-md p-4 border-r-2 border-[#343E4E]">
      {addToPurchase.length != 0 &&
        <span className="z-50 absolute top-20 left-9 inline-flex items-center justify-center w-4 h-4 text-xs font-bold text-white bg-red-500 rounded-full transform transition-transform duration-200">
