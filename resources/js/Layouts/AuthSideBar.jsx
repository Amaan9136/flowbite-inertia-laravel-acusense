...
const AuthSideBar = () => {
  ...
  return (
    <nav className="hidden sm:block min-w-[15rem] w-[15rem] space-y-2 bg-gray-50 text-black/60 dark:bg-gray-900 dark:text-white/60 shadow-md p-4 border-r-2 border-[#343E4E]">
